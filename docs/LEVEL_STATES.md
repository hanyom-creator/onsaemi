# Lv0~Lv5 에스컬레이션 상태 전이 v1.0

- WBS 1.2.2 / 확정일 2026-09-21
- 점수 규칙은 docs/RISK_WEIGHTS.md (v1.1)를 따른다.
...
| 3 | 80–89 | 거절 문장 (12자 이내) | 실사용 고려 짧은 대본 |
...
1. 신호 없는 청크가 30초(10청크) 연속이면 한 단계 내려간다.
...
- 판정 시간 = 3초 + (대본 글자 수 ÷ 초당 4글자), 3초 단위로 올림, 최소 6초·최대 30초
